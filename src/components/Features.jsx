  ...
  return (
    <section className="max-w-4xl mx-auto px-4 mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
      <div className="bg-white p-6 rounded-xl shadow-sm">
        <Heart className="mx-auto text-brand-caramelo mb-3" size={32} />
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm">
        <Star className="mx-auto text-brand-dourado mb-3" size={32} />
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm">
        <ChefHat className="mx-auto text-brand-caramelo mb-3" size={32} />
